...
container.Position = UDim2.new(0.275616446, 0, 2, 0)
container.Size = UDim2.new(0.430, 0, 0.23, 0)
container.Visible = false
container.CanvasSize = UDim2.new(0, 231, 0, 0)
...
Open.Position = UDim2.new(0.335616446, 0, 0.8976143, 0)
...
Frame.Position = UDim2.new(-0.050582762761, 0, 2, 0)
...
containerr.Size = UDim2.new(0, 506, 0, 258)
...
TextBox.PlaceholderText = "warn(\"Solarium V ,Still beta\")"
TextBox.Text = ""
...
exe.Position = UDim2.new(0.1 + (0 * #container:GetChildren()), 0, 0.3, 0)
...
hub.Position = UDim2.new(0.1 + (0.2 * #container:GetChildren()), 0, 0.3, 0)
...
searchpage.Position = UDim2.new(0.1 + (0.2 * #container:GetChildren()), 0, 0.3, 0)
...
setting.Position = UDim2.new(0.1 + (0.2 * #container:GetChildren()), 0, 0.3, 0)
...
if winState == 0 then
		...
		container:TweenPosition(UDim2.new(0.275616446, 0, 0.6876143, 0), 'In', 'Quad', 0.3, true)
